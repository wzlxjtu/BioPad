...
HWND Log_Button, Name_Box, Overlay_Button, User_Button, Zephyr_Button, Cronus_Button, Punish_Button, Manual_Button, Manual_Box, Control_Button, 
	HRV_Box, RR_Box, HR_Box, AVE_Box, hwndPB, Time_Box, Device_Box, Recovery_Box, Recovery_Button, Intensity_Box, Intensity_Button, Half_Button;
